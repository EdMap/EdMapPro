...
from src._prompts.offer_negotiation.termination_prompt import *
...
class TerminationAgent:
    ...
    def response(self):
        ...
        candidate_asked_to_stop_check = generate_offer_llm_response(
        ...
        # rudeness_response = generate_offer_llm_response(
