...
export class ApiBase<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
    api = {
         ...
         *
         * @tags api
         * @name ApiAuthRegisterCreate
         * @request POST:/api/auth/register/
         * @secure
         * @response `201` `User`
         */
        apiAuthRegisterCreate: (data: User, params: RequestParams = {}) =>
         ...
         */
        apiAuthTokenCreate: (data: TokenObtainPair, params: RequestParams = {}) =>
         ...
         */
        apiAuthTokenRefreshCreate: (data: TokenRefresh, params: RequestParams = {}) =>
    ...
    swaggerTypes = {
         ...
         *
         * @tags swagger-types
         * @name SwaggerTypesRetrieve
         * @request GET:/swagger-types/
         * @secure
         * @response `200` `Record<string,any>`
         */
        swaggerTypesRetrieve: (
            query?: {
                lang?:
                    | 'af'
                    | 'ar'
